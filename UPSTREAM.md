...
| Windows, Linux and macOS CI packaging through the upstream build environments and pipeline | `.github/workflows/rustdesk-tiny.yml`, `build.py`, `scripts/build-windows-tiny.ps1`, `scripts/build-linux-tiny.sh`, `scripts/build-macos-tiny.sh` |
...
| `.github/workflows/rustdesk-tiny.yml` | Builds and uploads Windows x86_64, Linux x86_64, macOS x86_64 and macOS arm64 Tiny artifacts using the upstream-pinned toolchains, Flutter patches, custom Windows engine and vcpkg setup. |
